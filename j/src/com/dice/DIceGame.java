...
class DiceGame{
  ...
  public void result() {
    if(point1 > point2) {
      System.out.println("Player1 "+p1.getName() + "'s total point : " + point1);
      System.out.println("Player2 "+p2.getName() + "'s total point : " + point2);
      System.out.println(" ");
      System.out.println("Player1 "+p1.getName() + " win!!!!!!");
      System.out.println("Player2 "+p2.getName() + " lose......");
